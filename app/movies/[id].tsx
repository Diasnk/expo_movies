  ...
  return (
    <View className='bg-primary flex-1'>
      <ScrollView contentContainerStyle={{
        ...
        <View>
          <Image source={{uri: posterUri}} className='w-full h-[550px]' resizeMode='stretch'/>
        </View>
        ...
        <View className='flex-col items-start justify-center mt-5 px-5'>
          ...
          <View className='flex flex-row justify-between w-1/2 '>
            <MovieInfo label='Budget' value={movie?.budget ? `$${(movie.budget / 1_000_000).toFixed(2)}M` : null}/>
            <MovieInfo label='Revenue' value={movie?.revenue ? `$${(movie.revenue / 1_000_000).toFixed(2)}M` : null}/>
          </View>
